...
// extrait automatiquement de https://trad.spip.net/tradlang_module/seenthis?lang_cible=de
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'auteur_block_you' => 'Dieser Autor hat Sie gesperrt, Sie können seine Nachrichten nicht kommentieren.', # MODIF
	...
	'auteurs_vous_suivez' => 'Sie folgen diesen Autoren', # MODIF
...
<p>Dieser Hinweis wird nicht mehr angezeigt, wenn Sie mindestens fünf Autoren folgen. Wählen Sie nun den Reiter  « @auteurs » um Autoren vorgeschlagen zu bekommen.</p>', # MODIF
	'modifier' => 'Bearbeiten',
	...
	'profil_alerte_dubien' => '<b>Ein Freund</b> / jemand folgt mir', # MODIF
	'profil_alerte_mes_billets' => '<b>Meine Beiträge</b> / eine Kopie meiner eigenen Beiträge erhalten',
	'profil_alerte_nolife' => '<b>nolife</b> / ein Autor, dem ich folge antwortet auf sämtliche Beiträge', # MODIF
	'profil_alerte_nouveaux_billets' => '<b>Neuer Beitrag</b> / ein Autor, dem ich folge, hat einen neuen Beitrag veröffentlicht.', # MODIF
	...
	'profil_logo' => 'Avatar (quadratisch)', # MODIF
	...
	'raccourci_quote' => '❝Zitat❞ (Umschalt+Tab)',
	'raccourci_strike' => '-<del>durchgestrichen</del>-',

	// S
	'slogan_lien' => 'Melden Sie sich an ! Es geht schnell und ist kostenlos.',
	'slogan_texte' => '<strong>Diskutieren Sie mit !</strong> Auf Seenthis können Sie Websiten verlinken und kommentieren, eigene Beiträge schreiben, mit Ihren Freunden diskutieren, interessanten Autoren folgen ...', # MODIF
	...
	'theme_manuellement' => 'Dieses <b>Thema</b> wurde von Autoren <b>manuell</b> in Beiträge eingefügt.', # MODIF
	...
	'vous_suivent' => 'Ihnen folgen', # MODIF
