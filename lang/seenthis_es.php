...
// extrait automatiquement de https://trad.spip.net/tradlang_module/seenthis?lang_cible=es
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'effacer' => 'borrar',
	'envoyer' => 'Enviar (mayúscula+retorno)',
...
<p>Este mensaje desaparecerá una vez que usted siga a cinco autores. Para encontrar más autores, pulse el botón "@autores".</p>', # MODIF
	...
	// P
	'pave_accueil' => '<strong>Short-blogging</strong> sin límite de caracteres. <strong>Recomendación de enlaces</strong>. <strong>Automatismos</strong> para redactar fácilmente los mensajes. <strong>Foros</strong> en todas las notas. <strong>Agenda de actualidad</strong>. Una <strong>tematización</strong> avanzada.', # MODIF
	...
	'profil_copyright_classique' => 'Ninguna licencia específica (derechos de autor por defecto)',
	'profil_couleur' => 'Su color',
	'profil_entete' => 'Banda superior (960 pixels de ancho)',
	'profil_fond' => 'Imagen de fondo (1600px x 1200px máximo)',
	'profil_graphisme' => 'Su gráfica',
	...
	'raccourci_italic' => '_<i>cursiva</i>_',
	'raccourci_quote' => '❝citación❞ (may+tab)',
	'raccourci_strike' => '-<del>tachado</del>-',
	...
	'suivre_url_stop' => 'Dejar de seguir este sitio',
	'suivre_url_you' => 'Usted sigue este sitio',
	...
	'traduire_avec_google' => 'traducir',

	// U
	'urls' => 'sitios',
	'urls_vous_suivez' => 'Sitios que usted sigue',
