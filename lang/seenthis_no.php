...
// extrait automatiquement de https://trad.spip.net/tradlang_module/seenthis?lang_cible=no
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// M
	'me_suggerer_contacts' => 'Foreslå kontakter',
	'message_inscription' => '<strong>Medlemskap er gratis og umiddelbart</strong><br>Passord blir umiddelbart sendt til din e-postadresse.',
	'message_suggerer' => '				<strong>Ny på Seenthis? Du bør starte med følgende bidragsytere.</ Strong>
	...
	// P
	'pave_accueil' => '<strong> "Short-blogging" </ strong> ubegrenset antall tegn. <strong> Anbefalte lenker </ strong>. Automatiseringer <strong> </ strong> for å skrive innlegg enkelt. <strong> Forum </ strong> under hvert innlegg. <strong> Like før nyheten </ strong>. Avansert <strong>tema</ strong>.', # MODIF
...
', # MODIF
	...
	'suivre_url_stop' => 'Ikke følg denne nettside lenger',
	'suivre_url_you' => 'Du følger denne nettside',
...
',
	'tous_les_messages_de' => 'Alle innleggene av @people@',
	'traduire_avec_google' => 'oversett',

	// U
	'urls' => 'Nettsider',
	'urls_vous_suivez' => 'Nettsider som du følger',

	// V
	'votre_message' => 'Din melding',
	'votre_message_public' => 'Din offentlige melding til',
	'vous_connaissez' => 'Kanskje kjenner du:',
	'vous_suivent' => 'abonnenter', # MODIF
